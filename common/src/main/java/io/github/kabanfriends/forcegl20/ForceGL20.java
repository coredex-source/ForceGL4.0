...
public class ForceGL20 {
    ...
    static {
        ...
        overrideBuilder.put(GLFW.GLFW_CONTEXT_VERSION_MAJOR, new HintOverride(OverrideType.SET_VALUE, 4));
        overrideBuilder.put(GLFW.GLFW_CONTEXT_VERSION_MINOR, new HintOverride(OverrideType.SET_VALUE, 0));
        overrideBuilder.put(GLFW.GLFW_OPENGL_PROFILE, new HintOverride(OverrideType.SET_VALUE, GLFW.GLFW_OPENGL_CORE_PROFILE)); // Core profile for OpenGL 4.0
        overrideBuilder.put(GLFW.GLFW_OPENGL_FORWARD_COMPAT, new HintOverride(OverrideType.SET_VALUE, GLFW.GLFW_TRUE)); // Forward compatibility
